...
const initialTasks = [
  ...
  },
  {
    ...
    description: "Create overall system architecture based on requirements",
    status: "in-progress",
    priority: "high",
    level: 0,
    dependencies: [],
    subtasks: [
      ...
      },
      {
        ...
        description:
          "Design diagrams showing how data will flow through system",
        status: "pending",
        priority: "medium",
      ...
      },
      {
        ...
        description: "Write detailed specifications for all APIs in system",
        status: "pending",
        priority: "high",
  ...
  },
  {
    ...
    subtasks: [
      ...
      },
      {
        ...
        description: "Configure automated testing frameworks for project",
        status: "pending",
        priority: "high",
  ...
  },
  {
    ...
    description: "Execute first development sprint based on the plan",
    status: "pending",
    priority: "medium",
    level: 1,
    dependencies: ["4"],
    subtasks: [
      {
        ...
        description:
          "Develop essential features identified in requirements",
        status: "pending",
        priority: "high",
      ...
      },
      {
        id: "5.3",
        title: "Document code",
        description: "Create documentation for implemented code",
        status: "pending",
        priority: "low",
